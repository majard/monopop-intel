        ...
        {lists.length === 0 ? (
          ...
          <div className="space-y-4">
            {lists.map((list) => (
              <div
                key={list.id}
                className="group bg-zinc-900 border border-zinc-800 hover:border-emerald-500/50 rounded-xl p-6 transition-all hover:shadow-xl cursor-pointer"
                onClick={() => window.location.href = `/shopping-lists/${list.id}`}
              >
