...
export default function ShoppingListDetailClient({ availableGenerics }: ShoppingListDetailClientProps) {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {list.items.length === 0 ? (
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-12 text-center">
            ...
            <p className="text-sm text-zinc-500 mt-2">Use "Colar lista" acima para começar.</p>
          </div>
        ) : (
