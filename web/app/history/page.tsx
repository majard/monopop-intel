            ...
            <div className="max-w-3xl mx-auto px-6 py-16">
                ...
                <form method="GET" className="mb-8">
                    <input
                        ...
                        className="w-full sm:w-72 bg-zinc-900 border border-zinc-700 rounded px-4 py-2 text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-emerald-500"
                    />
                </form>
                ...
                {filtered.length === 0 ? (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {filtered.map((t) => (
                            ...
                            <a key={t.term} href={`/history/${encodeURIComponent(t.term)}`}
